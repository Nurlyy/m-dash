...
class MainController extends AuthController
{
    ...
    {
        $this::$rating[$id] = (isset($this::$rating[$id]) ? $this::$rating[$id] : 0) + (isset($value['fb']) ? $value['fb'] : 0) + (isset($value['ig']) ? $value['ig'] : 0) + (isset($value['tg']) ? $value['tg'] : 0) + (isset($value['web']) ? $value['web'] : 0);
        ...
        $this::$postsSentimentLine[$id]['positive'] = (isset($this::$postsSentimentLine[$id]['positive']) ? $this::$postsSentimentLine[$id]['positive'] : 0) + (isset($value['fb_positive']) ? $value['fb_positive'] : 0) + (isset($value['tt_positive']) ? $value['tt_positive'] : 0) + (isset($value['mm_positive']) ? $value['mm_positive'] : 0) + (isset($value['yt_positive']) ? $value['yt_positive'] : 0) + (isset($value['gg_positive']) ? $value['gg_positive'] : 0) + (isset($value['tw_positive']) ? $value['tw_positive'] : 0) + (isset($value['ok_positive']) ? $value['ok_positive'] : 0) + (isset($value['vk_positive']) ? $value['vk_positive'] : 0) + (isset($value['vk_positive']) ? $value['vk_positive'] : 0) + (isset($value['gg_positive']) ? $value['gg_positive'] : 0) + (isset($value['tw_positive']) ? $value['tw_positive'] : 0) + (isset($value['yt_positive']) ? $value['yt_positive'] : 0) + (isset($value['ok_positive']) ? $value['ok_positive'] : 0) + (isset($value['mm_positive']) ? $value['mm_positive'] : 0) + (isset($value['tt_positive']) ? $value['tt_positive'] : 0) + (isset($value['ig_positive']) ? $value['ig_positive'] : 0) + (isset($value['tg_positive']) ? $value['tg_positive'] : 0) + (isset($value['web_positive']) ? $value['web_positive'] : 0);
        $this::$postsSentimentLine[$id]['neutral'] = (isset($this::$postsSentimentLine[$id]['neutral']) ? $this::$postsSentimentLine[$id]['neutral'] : 0) + (isset($value['fb_neutral']) ? $value['fb_neutral'] : 0) + (isset($value['tt_neutral']) ? $value['tt_neutral'] : 0) + (isset($value['mm_neutral']) ? $value['mm_neutral'] : 0) + (isset($value['yt_neutral']) ? $value['yt_neutral'] : 0) + (isset($value['gg_neutral']) ? $value['gg_neutral'] : 0) + (isset($value['tw_neutral']) ? $value['tw_neutral'] : 0) + (isset($value['ok_neutral']) ? $value['ok_neutral'] : 0) + (isset($value['vk_neutral']) ? $value['vk_neutral'] : 0) + (isset($value['vk_neutral']) ? $value['vk_neutral'] : 0) + (isset($value['gg_neutral']) ? $value['gg_neutral'] : 0) + (isset($value['tw_neutral']) ? $value['tw_neutral'] : 0) + (isset($value['yt_neutral']) ? $value['yt_neutral'] : 0) + (isset($value['ok_neutral']) ? $value['ok_neutral'] : 0) + (isset($value['mm_neutral']) ? $value['mm_neutral'] : 0) + (isset($value['tt_neutral']) ? $value['tt_neutral'] : 0) + (isset($value['ig_neutral']) ? $value['ig_neutral'] : 0) + (isset($value['tg_neutral']) ? $value['tg_neutral'] : 0) + (isset($value['web_neutral']) ? $value['web_neutral'] : 0);
        $this::$postsSentimentLine[$id]['negative'] = (isset($this::$postsSentimentLine[$id]['negative']) ? $this::$postsSentimentLine[$id]['negative'] : 0) + (isset($value['fb_negative']) ? $value['fb_negative'] : 0) + (isset($value['tt_negative']) ? $value['tt_negative'] : 0) + (isset($value['mm_negative']) ? $value['mm_negative'] : 0) + (isset($value['yt_negative']) ? $value['yt_negative'] : 0) + (isset($value['gg_negative']) ? $value['gg_negative'] : 0) + (isset($value['tw_negative']) ? $value['tw_negative'] : 0) + (isset($value['ok_negative']) ? $value['ok_negative'] : 0) + (isset($value['vk_negative']) ? $value['vk_negative'] : 0) + (isset($value['vk_negative']) ? $value['vk_negative'] : 0) + (isset($value['gg_negative']) ? $value['gg_negative'] : 0) + (isset($value['tw_negative']) ? $value['tw_negative'] : 0) + (isset($value['yt_negative']) ? $value['yt_negative'] : 0) + (isset($value['ok_negative']) ? $value['ok_negative'] : 0) + (isset($value['mm_negative']) ? $value['mm_negative'] : 0) + (isset($value['tt_negative']) ? $value['tt_negative'] : 0) + (isset($value['ig_negative']) ? $value['ig_negative'] : 0) + (isset($value['tg_negative']) ? $value['tg_negative'] : 0) + (isset($value['web_negative']) ? $value['web_negative'] : 0);
        ...
        // var_dump($this::$totalCommentsChart);
        // exit;
    ...
    public function actionCandidate()
    {
        ...
        if (strlen($start_date) < 11 && strlen($end_date) < 11 && is_numeric($city_id)) {
            $result = json_decode(get_web_page("frontend.test.localhost/backend/main/search?type=2&city_id={$city_id}&start_date={$start_date}&end_date={$end_date}"), true);
            $this->splitData($result);
            $dates = $this->getBetweenDates($start_date, $end_date);
            $temp = [];

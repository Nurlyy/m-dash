        ...
        foreach($result['all_data'] as $data){
            ...
            foreach($this::$organization_data as $key=>$value){
                ...
                if($value['id'] == $data['organization_id']){
                    ...
                    $this::$regions_data[$value['region']]['subs']['fb'] = (isset($this::$regions_data[$value['region']]['subs']['fb'])?$this::$regions_data[$value['region']]['subs']['fb']:0) + (isset($data['fb_subs'])?$data['fb_subs']:0);
                    $this::$regions_data[$value['region']]['subs']['ig'] = (isset($this::$regions_data[$value['region']]['subs']['ig'])?$this::$regions_data[$value['region']]['subs']['ig']:0) + (isset($data['ig_subs'])?$data['ig_subs']:0);
                    $this::$regions_data[$value['region']]['subs']['tg'] = (isset($this::$regions_data[$value['region']]['subs']['tg'])?$this::$regions_data[$value['region']]['subs']['tg']:0) + (isset($data['tg_subs'])?$data['tg_subs']:0);
                }
            ...
            $this::$total_likes[$data['organization_id']]['fb'] = (isset($this::$total_likes[$data['organization_id']]['fb'])?$this::$total_likes[$data['organization_id']]['ig']:0) + (isset($data['fb_likes'])?$data['fb_likes']:0);

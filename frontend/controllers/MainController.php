...
class MainController extends AuthController
{
    ...
    private function split_data($result)
    {
        ...
        foreach ($result['all_data'] as $data) {
            ...
            if (isset($data['fb_positive']) && isset($data['fb_neutral']) && isset($data['fb_negative'])) {
                $this::$resources_sentiments[$data['organization_id']]['fb_positive'] = (isset($this::$resources_sentiments[$data['organization_id']]['fb_positive']) ? $this::$resources_sentiments[$data['organization_id']]['fb_positive'] : 0) + $data['fb_positive'];
                $this::$resources_sentiments[$data['organization_id']]['fb_neutral'] = (isset($this::$resources_sentiments[$data['organization_id']]['fb_neutral']) ? $this::$resources_sentiments[$data['organization_id']]['fb_neutral'] : 0) + $data['fb_neutral'];
                $this::$resources_sentiments[$data['organization_id']]['fb_negative'] = (isset($this::$resources_sentiments[$data['organization_id']]['fb_negative']) ? $this::$resources_sentiments[$data['organization_id']]['fb_negative'] : 0) + $data['fb_negative'];
                // echo "TRUE\n";
            }
            if (isset($data['ig_positive']) && isset($data['ig_neutral']) && isset($data['ig_negative'])) {
                $this::$resources_sentiments[$data['organization_id']]['ig_positive'] = (isset($this::$resources_sentiments[$data['organization_id']]['ig_positive']) ? $this::$resources_sentiments[$data['organization_id']]['ig_positive'] : 0) + $data['ig_positive'];
                $this::$resources_sentiments[$data['organization_id']]['ig_neutral'] = (isset($this::$resources_sentiments[$data['organization_id']]['ig_neutral']) ? $this::$resources_sentiments[$data['organization_id']]['ig_neutral'] : 0) + $data['ig_neutral'];
                $this::$resources_sentiments[$data['organization_id']]['ig_negative'] = (isset($this::$resources_sentiments[$data['organization_id']]['ig_negative']) ? $this::$resources_sentiments[$data['organization_id']]['ig_negative'] : 0) + $data['ig_negative'];
                // echo "FALSE\n";
            }
            if (isset($data['tg_positive']) && isset($data['tg_neutral']) && isset($data['tg_negative'])) {
                $this::$resources_sentiments[$data['organization_id']]['tg_positive'] = (isset($this::$resources_sentiments[$data['organization_id']]['tg_positive']) ? $this::$resources_sentiments[$data['organization_id']]['tg_positive'] : 0) + $data['tg_positive'];
                $this::$resources_sentiments[$data['organization_id']]['tg_neutral'] = (isset($this::$resources_sentiments[$data['organization_id']]['tg_neutral']) ? $this::$resources_sentiments[$data['organization_id']]['tg_neutral'] : 0) + $data['tg_neutral'];
                $this::$resources_sentiments[$data['organization_id']]['tg_negative'] = (isset($this::$resources_sentiments[$data['organization_id']]['tg_negative']) ? $this::$resources_sentiments[$data['organization_id']]['tg_negative'] : 0) + $data['tg_negative'];
            }
            if (isset($data['web_positive']) && isset($data['web_neutral']) && isset($data['web_negative'])) {
                $this::$resources_sentiments[$data['organization_id']]['web_positive'] = (isset($this::$resources_sentiments[$data['organization_id']]['web_positive']) ? $this::$resources_sentiments[$data['organization_id']]['web_positive'] : 0) + $data['web_positive'];
                $this::$resources_sentiments[$data['organization_id']]['web_neutral'] = (isset($this::$resources_sentiments[$data['organization_id']]['web_neutral']) ? $this::$resources_sentiments[$data['organization_id']]['web_neutral'] : 0) + $data['web_neutral'];
                $this::$resources_sentiments[$data['organization_id']]['web_negative'] = (isset($this::$resources_sentiments[$data['organization_id']]['web_negative']) ? $this::$resources_sentiments[$data['organization_id']]['web_negative'] : 0) + $data['web_negative'];
            }
    ...
    public function actionResources()
    {
        ...
        foreach ($this::$organization_data as $organization) {
            ...
            foreach ($this::$resources_sentiments[$organization['id']] as $key => $value) {
                $temp_sentiments[$key] = (isset($temp_sentiments[$key]) ? $temp_sentiments[$key] : 0) + $value;
            }
        }
        // var_dump($temp_sentiments);
        // exit;
        $this::$resources_sentiments = $temp_sentiments;
    ...
    public function actionRegions()
    {
        ...
        foreach ($this::$organization_data as $organization) {
            foreach ($this::$date_posts[$organization['id']] as $date => $values) {
                $temp_date_posts[$organization['id']][$date] = (isset($temp_date_posts[$organization['id']][$date]) ? $temp_date_posts[$organization['id']][$date] : 0) + (isset($values['fb']) ? $values['fb'] : 0) + (isset($values['ig']) ? $values['ig'] : 0) + (isset($values['tg']) ? $values['tg'] : 0) + (isset($values['web']) ? $values['web'] : 0);
            }
            foreach ($this::$resources_sentiments as $key => $value) {
                if ($key == $organization['id']) {
                    $temp_sentiments[$organization['id']]['positive'] = (isset($temp_sentiments[$organization['id']]['positive']) ? $temp_sentiments[$organization['id']]['positive'] : 0) + (isset($value['fb_positive']) ? $value['fb_positive'] : 0) + (isset($value['ig_positive']) ? $value['ig_positive'] : 0) + (isset($value['tg_positive']) ? $value['tg_positive'] : 0) + (isset($value['web_positive']) ? $value['web_positive'] : 0);
                    $temp_sentiments[$organization['id']]['neutral'] = (isset($temp_sentiments[$organization['id']]['neutral']) ? $temp_sentiments[$organization['id']]['neutral'] : 0) + (isset($value['fb_neutral']) ? $value['fb_neutral'] : 0) + (isset($value['ig_neutral']) ? $value['ig_neutral'] : 0) + (isset($value['tg_neutral']) ? $value['tg_neutral'] : 0) + (isset($value['web_neutral']) ? $value['web_neutral'] : 0);
                    $temp_sentiments[$organization['id']]['negative'] = (isset($temp_sentiments[$organization['id']]['negative']) ? $temp_sentiments[$organization['id']]['negative'] : 0) + (isset($value['fb_negative']) ? $value['fb_negative'] : 0) + (isset($value['ig_negative']) ? $value['ig_negative'] : 0) + (isset($value['tg_negative']) ? $value['tg_negative'] : 0) + (isset($value['web_negative']) ? $value['web_negative'] : 0);
                }
            }
            foreach ($this::$total_posts as $key => $post) {
                if ($key == $organization['id']) $temp_posts[$organization['id']] = (isset($temp_posts[$organization['id']]) ? $temp_posts[$organization['id']] : 0) + (isset($post['fb']) ? $post['fb'] : 0) + (isset($post['ig']) ? $post['ig'] : 0) + (isset($post['tg']) ? $post['tg'] : 0) + (isset($post['web']) ? $post['web'] : 0);
            }
        }

        $this::$resources_sentiments = $temp_sentiments;

        $this::$date_posts = $temp_date_posts;


        // sort($temp_posts);
        $this::$total_posts = $temp_posts;
        // var_dump(end($this::$date_posts[1]));
        // exit;
        uasort($this::$total_posts, function ($a, $b) {
            if ($a == $b) {
                return 0;
